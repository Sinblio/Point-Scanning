...
public class PolarAngleComparator implements Comparator<Point>
{
    ...
    {
    	if ((crossProduct(p1, p2) == 0) && (dotProduct(p1, p2) > 0))
    		return 0;
    	...
    	if (!p2.equals(referencePoint))
    	{
    		...
    		if (p1.getY() == referencePoint.getY())
    		{
    			if (p2.getY() < referencePoint.getY())
    				return -1;
    			if (p2.getY() == referencePoint.getY() && p1.getX() > referencePoint.getX() && p2.getX() < referencePoint.getX())
    				return -1;
    ...
    {
    	int cros;
    	cros = (p1.getX() - referencePoint.getX()) * (p2.getY() - referencePoint.getY());
    	cros -= (p1.getY() - referencePoint.getY()) * (p2.getX() - referencePoint.getX());
    	return cros; 
    }
    ...
    {
    	int dot;
    	dot = (p1.getX() - referencePoint.getX()) * (p2.getX() - referencePoint.getX());
    	dot += (p1.getY() - referencePoint.getY()) * (p2.getY() - referencePoint.getY());
    	return dot; 
    }
}
